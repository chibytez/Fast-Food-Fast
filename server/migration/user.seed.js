...
db.query(user, (err, res) => {
  ...
  const order = {
    text: 'INSERT INTO orders(user_id, users_name, users_email, date, status, item, price) VALUES($1, $2, $3, NOW() ,$4, $5, $6,$7) RETURNING id',
  ...
  db.query(order, (err, res) => {
    ...
    const order2 = {
      text: 'INSERT INTO requests(user_id, users_name, users_email, date, status, item, price) VALUES($1, $2, $3, NOW() ,$4, $5, $6,$7)',
