...
db.query(user, (err, res) => {
  ...
  db.query(user2, (err, res) => {
    ...
    const order = {
      text: 'INSERT INTO orders( user_id, email, meal, price, option, status) VALUES($1, $2, $3,$4, $5, $6)',
      values: [res.rows[0].id,'myexample@gmail.com', 'pizza', 3000, 'accept', 'processing'],
    };
